    ...
    <div class="p-col-12">
      <div class="card">
        ...
        <Dialog v-model:visible="workTypeDialog" :style="{width: '450px'}" :header="workTypeDialogHeader" :modal="true" class="p-fluid">
          ...
          <template #footer>
            <Button label="Cancel" icon="pi pi-times" class="p-button-text" @click="workTypeDialog = false"/>
            <Button label="Save" icon="pi pi-check" class="p-button-text" @click="saveWorkType" />
          </template>
        </Dialog>
        ...
        <Dialog v-model:visible="deleteWorkTypeDialog" :style="{width: '450px'}" :header="$t('general.deleteComfirmTitle')" :modal="true">
          ...
          <template #footer>
            <Button label="No" icon="pi pi-times" class="p-button-text" @click="deleteWorkTypeDialog = false"/>
            <Button label="Yes" icon="pi pi-check" class="p-button-text" @click="deleteWorkType" />
          </template>
        </Dialog>
        ...
        <Dialog v-model:visible="updateSelectedDialog" :style="{width: '450px'}" :header="$t('masterWorkType.updateSelectedWorkTypeTitle')" :modal="true" class="p-fluid">
          ...
          <template #footer>
            ...
            <Button label="Yes" icon="pi pi-check" class="p-button-text" @click="updateSelectedWorkTypes" />
          </template>
        </Dialog>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    loadDataTable(sort = null, page = 1) {
      ...
      this.queryWorkTypes(routerQuery.q, routerQuery.sort, routerQuery.page, routerQuery.pageSize);
    },
    queryWorkTypes(query, sort, page, pageSize) {
      this.loading = true;
      this.workTypeService.queryWorkTypes(query, sort, page, pageSize)
        .then(response => {
